...
def main():
    ...
    # Filter generating network # [32,128,64,128,64,256,128]-> not good
    parser.add_argument('--fnet_widths', default='[32,128,64,128,64]', help='List of width of hidden filter gen net layers (excluding the input and output ones, they are automatic)')
    ...
    parser.add_argument('--ptn_widths', default='[[64,64,128,128,256,256,512], [512,256,64,32]]', help='PointNet widths') #   [[64,64,128,128,256,256,512,512,1024], [1024,512,256,64,32]]-> not good
